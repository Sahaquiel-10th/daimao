...
EOF
  ...
  echo "Created ${ENV_FILE}. Fill TENCENTCLOUD_SECRETID, TENCENTCLOUD_SECRETKEY, ADMIN_WEB_TOKEN, ADMIN_SUPER_PASSWORD and ADMIN_SESSION_SECRET before using the admin API proxy."
fi
