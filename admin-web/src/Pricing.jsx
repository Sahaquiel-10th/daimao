...
export default function PricingPage({ onError, onToast, onBack }) {
  ...
  return <section className="pricing-page">
    <header className="pricing-heading"><div><p className="eyebrow">AI POWER PRICING</p><h2>AI 电力计价</h2><p>设置面向客户的结算价格。倍率由数据中心根据固定基准计算并发布。</p></div><div className="pricing-heading-actions"><button onClick={onBack} disabled={publishing}>返回账单中心</button><button onClick={() => loadCurrent()} disabled={loading || publishing}>刷新当前方案</button></div></header>
